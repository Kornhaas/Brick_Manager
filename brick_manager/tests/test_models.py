...
class TestRebrickableSets:
    ...
    def test_rebrickable_set_repr(self, app):
        ...
        with app.app_context():
            rebrickable_set = RebrickableSets(
                set_num="10001-1", name="Test Set", year=2023, theme_id=1
            )
...
class TestRebrickableColors:
    ...
    def test_create_color(self, app):
        ...
        with app.app_context():
            color = RebrickableColors(id=1, name="Red", rgb="FF0000", is_trans=False)
    ...
    def test_create_user_set(self, app):
        ...
        with app.app_context():
            ...
            template_set = RebrickableSets(
                set_num="10001-1", name="Test Set", year=2023, theme_id=1, num_parts=100
            )
    ...
    def test_create_user_minifigure_part(self, app):
        ...
        with app.app_context():
            ...
            minifigure = User_Minifigures(
                fig_num="fig-001", quantity=1, user_set_id=user_set.id
            )
...
class TestModelRelationships:
    ...
    def test_part_category_relationship(self, app):
        ...
        with app.app_context():
            ...
            part = RebrickableParts(part_num="3001", name="Brick 2 x 4", part_cat_id=1)
            db.session.add(part)
            db.session.commit()
