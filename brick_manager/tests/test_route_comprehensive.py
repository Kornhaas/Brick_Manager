...
class TestRouteComprehensive:
    ...
    def test_dashboard_route_structure(self):
        ...
        try:
            ...
            functions = [
                attr
                for attr in dir(dashboard_module)
                if callable(getattr(dashboard_module, attr))
            ]
    ...
    def test_missing_parts_route_comprehensive(self):
        ...
        try:
            ...
            functions = [
                attr
                for attr in dir(missing_parts_module)
                if callable(getattr(missing_parts_module, attr))
