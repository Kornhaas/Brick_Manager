...
def sync_all_missing_parts():
    ...
    try:
        ...
        combined_result = {
            ...
            'summary': {
                'regular_local_count': regular_result.get('summary', {}).get('local_missing_count', 0),
                'minifig_local_count': minifig_result.get('summary', {}).get('local_missing_count', 0),
                'regular_added': regular_result.get('summary', {}).get('actual_added', 0),
                'minifig_added': minifig_result.get('summary', {}).get('actual_added', 0),
                'regular_removed': regular_result.get('summary', {}).get('actual_removed', 0),
                'minifig_removed': minifig_result.get('summary', {}).get('actual_removed', 0),
                'regular_list_id': regular_result.get('summary', {}).get('list_id'),
                'minifig_list_id': minifig_result.get('summary', {}).get('list_id')
            }
        }
        
        total_local = combined_result['summary']['regular_local_count'] + combined_result['summary']['minifig_local_count']
        total_added = combined_result['summary']['regular_added'] + combined_result['summary']['minifig_added']
        total_removed = combined_result['summary']['regular_removed'] + combined_result['summary']['minifig_removed']
