...
try:
    ...
    from models import User_Minifigures, User_Parts, User_Set, UserMinifigurePart
    ...
    assert hasattr(
        User_Set, "template_set"
    ), "User_Set missing template_set relationship"
    assert hasattr(
        User_Set, "parts_in_set"
    ), "User_Set missing parts_in_set relationship"
    assert hasattr(
        User_Set, "minifigures_in_set"
    ), "User_Set missing minifigures_in_set relationship"
    ...
    assert hasattr(
        User_Parts, "rebrickable_part"
    ), "User_Parts missing rebrickable_part relationship"
    assert hasattr(
        User_Parts, "rebrickable_color"
    ), "User_Parts missing rebrickable_color relationship"
    ...
    assert hasattr(
        UserMinifigurePart, "part_num"
    ), "UserMinifigurePart missing part_num"
    assert hasattr(
        UserMinifigurePart, "color_id"
    ), "UserMinifigurePart missing color_id"
    assert hasattr(
        UserMinifigurePart, "rebrickable_part"
    ), "UserMinifigurePart missing rebrickable_part relationship"
    assert hasattr(
        UserMinifigurePart, "rebrickable_color"
    ), "UserMinifigurePart missing rebrickable_color relationship"
