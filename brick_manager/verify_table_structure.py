...
def check_table_structure():
    ...
    with app.app_context():
        ...
        cursor.execute('SELECT sql FROM sqlite_master WHERE type="table" AND name="rebrickable_parts";')
        ...
        if result:
            ...
            required_columns = ['part_num', 'name', 'part_cat_id', 'part_material', 'part_img_url', 'part_url']
